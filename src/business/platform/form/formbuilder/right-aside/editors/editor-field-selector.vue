  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      <!-- <el-form-item v-if="fieldOptions.store==='bind'">
        <template slot="label">绑定值<help-tip prop="bind" /></template>
        <el-select
...
import { selectorTypeOptions, selectorStoreOptions, bindValueOptions, selectorScopeOption } from '@/business/platform/form/constants/fieldOptions'
...
export default {
  ...
  data() {
    return {
      ...
      bindValueOptions: bindValueOptions,
      editData: {},
      props: {
        children: 'children',
        label: 'name'
  ...
  methods: {
    changeBoName(data) {
      if (data.key === 'id' || data.key === 'parentId' || data.type === 'table') {
        this.$message({
          title: '提示',
          message: '此字段不能用作存储！',
          type: 'warning'
