<template>
  <div class="form-property">
    ...
    >
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <el-form-item label-width="145px">
            <template slot="label">表单域标签的后缀<help-tip prop="formSuffix" /></template>
      ...
      <!-- <div class="panel panel-default">
        <div class="panel-heading">水印设置<help-tip prop="formSubmit" /></div>
        <div class="panel-body">

          <el-button style="width:100%;" type="primary" icon="ibps-icon-file-code-o" @click="editFormScript()">水印设置</el-button>
        </div>
      </div> -->
  ...
  methods: {
    ...
    handlerFormScript(value) {
      if (this.formType === 'mobile') {
        this.formDef.attrs.mobile_script = value
      } else {
