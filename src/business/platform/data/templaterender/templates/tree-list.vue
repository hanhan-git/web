  ...
  >
    ...
    >
      <template-list
        ...
        :fields="fields(rightDataTemplate)"
        :preview="preview"
        :height="dataTemplate.type === 'dialog'?templateHeight-(templateHeight/12):templateHeight"
...
export default {
  ...
  data() {
    return {
      ...
      rootIndex: 0,
      treeWidth: 250,
      // templateHeight: document.body.clientHeight - (document.body.clientHeight / 20),
    ...
    template: {
      handler(val, oldVal) {
        ...
        if (this.$utils.isNotEmpty(this.height)) {
          ...
          if (this.preview) {
            this.templateHeight = document.body.clientHeight - (document.body.clientHeight / 20)
          } else {
