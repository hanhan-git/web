  ...
  >
    ...
    >
      ...
      <!-- <el-form-item label="基准URL:" prop="baseUrl" class="ibps-md-0">
        ...
        <div v-if="!readonly" class="ibps-help-block">如果不填写，则默认当前系统的web访问地址根路径。例：http://web.lc.com/</div>
      </el-form-item> -->
      <el-form-item v-if="!subsystem.isLocal" label="子系统地址:" prop="homePage">
        ...
        <div v-if="!readonly" class="ibps-help-block">首页的路径。例：http://www.lc.com/，也可以写好的vue页面</div>
      </el-form-item>
