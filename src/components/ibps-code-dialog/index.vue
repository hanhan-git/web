<template>
  <el-dialog
    ...
    :title="title"
    class="ibps-code-dialog ibps-dialog-70"
    width="50%"
    append-to-body
    @close="closeDialog"
    @open="getFormData"
  >
    <el-tabs type="border-card">
      <el-tab-pane label="Vue 源码">
        <codemirror ref="templateScript" v-model="templateScript" :options="cmOption" />
      </el-tab-pane>
    </el-tabs>

    <div slot="footer" class="el-dialog--center cobyOrderSn">
      <el-button class="copyBtn" type="primary" data-clipboard-action="copy" :data-clipboard-text="templateScript" @click="copy">复制代码</el-button>
