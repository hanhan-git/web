...
const base = env.VUE_APP_BASE_API || (optionsEnv.length > 0 ? optionsEnv[0].value : '')

const websocket = env.VUE_APP_BASE_WEBSOCKET || (optionsEnv.length > 0 ? optionsEnv[0].value : '')
